    ...
    <div className="container mx-auto px-4 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
          ...
          <p className="font-body text-lg text-muted-foreground leading-relaxed">
            We believe that luxury should be accessible without compromise. Al Haay bridges the gap between international prestige perfumery and attainable elegance, delivering fragrances that rival the world's most exclusive maisons at a fraction of the cost. Every bottle is a testament to our unwavering commitment to quality, longevity, and artistry.
          </p>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}>
          <h3 className="font-display text-2xl text-foreground mb-4">The Al Haay Promise</h3>
